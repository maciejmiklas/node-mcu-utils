...
local function mapCode(codeStr)
	...
	-- ICON_IDX_RAIN
	elseif code == 9 or code == 11 or code == 12 or code == 17  or code == 35 or code == 19 or code == 39 then
		mapped = 3
	...
	-- ICON_IDX_MIX_SLEET		
	elseif code == 5 or code == 6 or code == 7 or code == 8  or code == 10 or code == 18 then
		mapped = 7	
